              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown {{ Request::is('fulfillment*') ? 'active' : '' }}" data-nav-permission="nav.fulfillment">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="https://fab.vosglassintra.net/doorconfig" target="_blank" rel="noopener">Door Configurator <span class="badge bg-yellow-lt text-yellow ms-auto">Beta</span></a>
                  </div>
                </li>

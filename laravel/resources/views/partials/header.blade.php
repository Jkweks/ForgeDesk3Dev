    ...
    <div class="navbar-nav flex-row order-md-last">
      ...
      <div class="nav-item dropdown d-none d-md-flex me-3">
        <a href="#" class="nav-link px-0" data-bs-toggle="dropdown" tabindex="-1" aria-label="Show notifications">
          ...
          <span class="badge text-bg-red d-none" id="notificationBadge"></span>
        </a>
        <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
          <div class="card">
            ...
            <div class="list-group list-group-flush list-group-hoverable" id="notificationList">
        ...
        (function () {
          ...
          function renderNotifications(notifications) {
            ...
            if (!notifications || notifications.length === 0) {
              ...
              list.innerHTML = '<div class="list-group-item"><div class="row align-items-center"><div class="col text-truncate"><div class="text-muted">No new notifications</div></div></div></div>';
              return;
            }
